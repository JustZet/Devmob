...
const services = [
  {
    ...
    accent: "from-blue-500/20 to-blue-700/5 border-blue-400/20 text-blue-300",
  },
  {
    icon: Code2,
    ...
    accent: "from-violet-500/20 to-violet-700/5 border-violet-400/20 text-violet-300",
  },
  {
    icon: Layers,
    ...
    accent: "from-cyan-500/20 to-cyan-700/5 border-cyan-400/20 text-cyan-300",
  },
  {
    icon: Zap,
    title: "Performance-First",
    body: "Profiled, optimized builds — fast cold starts, low memory pressure, and smooth scrolling. We measure before we ship.",
    accent: "from-amber-500/20 to-amber-700/5 border-amber-400/20 text-amber-300",
  },
  {
    icon: ShieldCheck,
    ...
    accent: "from-emerald-500/20 to-emerald-700/5 border-emerald-400/20 text-emerald-300",
  },
  {
    icon: Rocket,
    ...
    accent: "from-pink-500/20 to-pink-700/5 border-pink-400/20 text-pink-300",
  },
];
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          backgroundImage:
            "linear-gradient(to right, rgba(248,250,252,0.4) 1px, transparent 1px), linear-gradient(to bottom, rgba(248,250,252,0.4) 1px, transparent 1px)",
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="services-heading text-center mb-16 md:mb-20">
          <span className="inline-block text-xs uppercase tracking-[0.25em] font-bold text-blue-400 mb-4">
            What we build
          </span>
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground mb-6">
            Native Android &amp; <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 bg-clip-text text-transparent">Cross-Platform</span> apps
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-7">
          {services.map((s, i) => {
            ...
            return (
              <article
                key={i}
                className="service-card group relative rounded-2xl border border-white/[0.06] bg-gradient-to-br from-white/[0.03] to-white/[0.01] p-6 md:p-7 backdrop-blur-sm transition-all duration-500 hover:border-white/15 hover:-translate-y-1 hover:shadow-[0_30px_60px_-20px_rgba(0,0,0,0.6)]"
              >
                <div
                ...
                <div
                  className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"
                  aria-hidden="true"
                />
              </article>
            );
