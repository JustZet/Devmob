...
export function CinematicHero({
  brandName = "Devmob",
  tagline1 = "Build it native,",
  tagline2 = "ship it everywhere.",
  cardHeading = "Mobile engineering, end to end.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">Devmob</span> delivers production-grade
      mobile apps — pure Android in <span className="text-white font-semibold">Java</span>{" "}
      and <span className="text-white font-semibold">Kotlin</span>, plus cross-platform
      builds with <span className="text-white font-semibold">Flutter</span> for iOS and Android.
    </>
  ),
  metricValue = 100,
  metricLabel = "Apps Shipped",
  ctaHeading = "Let's build your app.",
  ctaDescription = "From idea to App Store and Google Play. Native Android (Java/Kotlin) or cross-platform Flutter — we deliver both.",
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          >
            <svg className="w-7 h-7 transition-transform group-hover:scale-105" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Email us</div>
              <div className="text-xl font-bold leading-none tracking-tight">{ctaPrimaryLabel}</div>
            </div>
          </a>
          <a
            href="#services"
          ...
          >
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Discover</div>
              <div className="text-xl font-bold leading-none tracking-tight">{ctaSecondaryLabel}</div>
            </div>
          </a>
        </div>
      </div>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-blue-500/20 to-blue-900/10 flex items-center justify-center border border-blue-400/30 shadow-inner">
                    <svg className="w-4 h-4 lg:w-5 lg:h-5 text-blue-300" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Native Android</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Java &amp; Kotlin</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-400/30 shadow-inner">
                    <svg className="w-4 h-4 lg:w-5 lg:h-5 text-indigo-300" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Cross-Platform</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Flutter — iOS + Android</p>
                  </div>
                </div>
